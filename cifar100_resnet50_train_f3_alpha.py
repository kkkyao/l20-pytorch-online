...
# -*- coding: utf-8 -*-
"""
PyTorch BF-style (B+F3 + alpha-mix) online meta-learning on CIFAR-100 with ResNet-50.
------------------------------------------------------------------------------------
...
def main():
    ...
    ap.add_argument("--wandb_group", type=str, default="cifar100_resnet50_f3alpha_bf3pt")
    ...
    method_name = "learned_l_f3alpha_cifar100_resnet50_online_pt"

    run_name = (
        f"cifar100_resnet50_f3alpha_data{args.data_seed}_seed{args.seed}_alpha{alpha:.3f}_"
    ...
    # IMPORTANT: first version already includes val_loss/val_acc columns
    ...
    for epoch in range(args.epochs):
        ...
        print(
            f"[CIFAR100-ResNet50-F3Alpha-PT EPOCH {epoch}] "
    ...
    # Optional: reduce fragmentation before eval
    if device.type == "cuda":
    ...
    print(
        f"[RESULT-CIFAR100-ResNet50-F3Alpha-PT] TestAcc={final_test_acc:.4f} "
