...
def main():
    ...
    # Run directory: encode that this is MLP + F3 + alpha
    run_name = (
        f"mlp_f3alpha_L{args.mlp_layers}_W{args.mlp_width}_"
    ...
    print(
        f"[RESULT-MLP-F3-ALPHA-PT] TestAcc={final_test_acc:.4f} "
