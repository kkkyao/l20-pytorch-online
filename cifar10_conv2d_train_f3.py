...
# -*- coding: utf-8 -*-
"""
PyTorch BF-style (B+F3) online meta-learning on CIFAR-10 with a Conv2D backbone.
-------------------------------------------------------------------------------

This is the CIFAR-10 Conv2D counterpart of the MNIST-1D F3 BF-style code.
...
class BatchLossLogger:
    """
    Lightweight BatchLossLogger aligned with the CIFAR-10 F1/F2 versions.
...
class LearnedL(nn.Module):
    """
    Simple MLP mapping phi = [log ||g||, log ||m||, ||m - g||]
...
def main():
    ...
    # Learner / optimizer hyperparameters (aligned with F1/F2, plus EMA beta)
    ...
    ap.add_argument(
        "--wandb_group",
        type=str,
        default="cifar10_conv2d_f3_bf1pt",
    ...
    # Run directory: encode CIFAR-10 + Conv2D + F3
    run_name = (
    ...
    curve_logger = BatchLossLogger(
        run_dir,
        meta={
            "method": "learned_l_f3_cifar10_conv2d",
            "seed": args.seed,
            "opt": "learnedL",
            "lr": args.theta_lr,
        },
    ...
    for epoch in range(args.epochs):
        ...
        for xb, yb in train_loader:
            ...
            # --- 3) Compute F3 feature: phi_t = [log ||g_t||, log ||m_t||, ||m_t - g_t||] ---
    ...
    print(
        f"[RESULT-CIFAR10-Conv2D-F3-PT] TestAcc={final_test_acc:.4f} "
