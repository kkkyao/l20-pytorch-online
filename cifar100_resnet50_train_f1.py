...
# -*- coding: utf-8 -*-
"""
PyTorch BF-style (B+F1) online meta-learning on CIFAR-100 with a ResNet-50 backbone.
-----------------------------------------------------------------------------------

This is a CIFAR-100 + ResNet-50 adaptation of your CIFAR-10 + ResNet-18 F1 script.

Key alignment with your F1 "stability additions":
  ...
  - Per-epoch eta/L/phi/dot statistics logged to eta_stats.csv
...
def main():
    ...
    ap.add_argument("--wandb_group", type=str, default="cifar100_resnet50_f1_bf1pt")
    ...
    run_name = (
        f"cifar100_resnet50_f1_data{args.data_seed}_seed{args.seed}_"
    ...
    if args.wandb:
        ...
        wandb_config = {
            ...
            "method": "learned_l_f1_cifar100_resnet50_online_pt",
            "seed": args.seed,
    ...
    train_loader, val_loader = make_train_val_loaders(
        ...
        seed=args.seed,
        train_shuffle=True,
        val_shuffle=True,   # F1: online val sampling
    ...
    # ------------------------------ logs ------------------------------
    method_name = "learned_l_f1_cifar100_resnet50_online_pt"
    ...
    result = {
        "stage": "online-train",
        "dataset": "CIFAR-100 (ResNet50 CIFAR-stem)",
        "method": "learned_l_f1_cifar100_resnet50_online_pt",
