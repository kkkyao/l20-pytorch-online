...
def main():
    ...
    run_name = (
        f"f1_conv1d_data{args.data_seed}_seed{args.seed}_"
    ...
    curve_logger = BatchLossLogger(
        run_dir,
        meta={"method": "learned_l_f1", "seed": args.seed, "opt": "learnedL", "lr": args.theta_lr},
    )
    ...
    print(
        f"[RESULT-F1-PT] TestAcc={final_test_acc:.4f} "
