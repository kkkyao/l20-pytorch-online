...
# -*- coding: utf-8 -*-
"""
PyTorch reimplementation of train_mnist1d_step3_BF1.py (Conv1D backbone).
...
Key design:
  - Strictly follows the TF online meta-learning logic:
  ...
  - Data preprocessing, normalization, and log file naming are aligned
    with the original TensorFlow code as much as possible.
"""
...
def main():
    ...
    # Learner hyperparameters (aligned with the TF implementation)
    ...
    ap.add_argument(
        "--wandb_group",
        type=str,
        default="mnist1d_conv1d_f1_bf_online",
    ...
    # Run directory: keep naming aligned with the TF code
    run_name = (
        f"mnist1d_conv1d_f1_data{args.data_seed}_seed{args.seed}_"
    ...
    if args.wandb:
        ...
        wandb_config = {
            ...
            "dataset": "MNIST-1D",
            "backbone": "Conv1D",
            "method": "learned_l_f1_mnist1d_conv1d_online_pt",
            "length": args.length,
            "seed": args.seed,
    ...
    curve_logger = BatchLossLogger(
        run_dir,
        meta={
            "method": "learned_l_f1_mnist1d_conv1d",
            "seed": args.seed,
            "opt": "learnedL",
            "lr": args.theta_lr,
        },
    ...
    for epoch in range(args.epochs):
        ...
        for xb, yb in train_loader:
            ...
            if global_step < args.warmup_steps:
                # Warmup logic aligned with the TF implementation
                warmup_max = min(
                    args.eta_max,
    ...
    print(
        f"[RESULT-MNIST1D-Conv1D-F1-PT] TestAcc={final_test_acc:.4f} "
