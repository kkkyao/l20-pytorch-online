...
Stabilized / aligned version:
  ...
  - Per-epoch eta/L/phi/dot stats logged to eta_stats_f3.csv

F3 feature:
  phi = [log||g||, log||m||, ||m-g||]
Meta dot direction: <grad_val, m>  (momentum direction, aligned with BF2/BF3 variants)
...
def main():
    ...
    # aligned stability / regularization knobs (same as ResNet18-F2 aligned)
    ...
    ap.add_argument("--wandb_group", type=str, default="cifar10_resnet18_f3_bf3pt")
    ...
    curve_logger = BatchLossLogger(
        run_dir,
        meta={"method": "learned_l_f3_cifar10_resnet18_online_pt", "seed": args.seed, "opt": "learnedL", "lr": args.theta_lr},
    )
